...
REGISTRAR_PROC = "RegistrarDocente"
REGISTRAR_EXISTENTE_PROC = "RegistrarDocenteUserExist"
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if id_usuario:
            ...
            cursor.callproc(REGISTRAR_EXISTENTE_PROC, required_fields)
            ...
            if registro_result and registro_result[0] == "FAILED_ALREADY_REGISTERED":
                return {
                    ...
                    "body": json.dumps({
                        "status": FAILED,
                        "message": "El usuario ya está registrado como docente."
                    })
                }
            ...
            response = {
                ...
                "body": json.dumps({
                    "status": SUCCESS,
                    "message": "Usuario existente registrado como docente exitosamente.",
            ...
            required_fields = [
                ...
                num_documento, img_b64, id_institucion, especialidad
            ]
            ...
            cursor.callproc(REGISTRAR_PROC, [
                ...
                tipo_doc, num_documento, id_institucion, especialidad
            ])
            ...
            response = {
                ...
                "body": json.dumps({
                    "status": SUCCESS,
                    "message": "Usuario registrado como docente exitosamente.",
                    "id_usuario": id_usuario,
                    "id_docente": id_docente
                })
            }
        ...
        response = {
            ...
            "body": json.dumps({
                "status": FAILED,
                "message": "Ocurrió un error durante el registro del docente."
            })
        }
